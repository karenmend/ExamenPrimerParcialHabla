    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if( frecuenciaFundamental > 390 && frecuenciaFundamental < 410)
                {
                    lblcolor.Text = "Color rojo.";
                }
                if (frecuenciaFundamental > 790 && frecuenciaFundamental < 810)
                {
                    lblcolor.Text = "Color verde.";
                }
                if (frecuenciaFundamental > 1190 && frecuenciaFundamental < 1210)
                {
                    lblcolor.Text = "Color morado.";
                }
                if (frecuenciaFundamental > 1590 && frecuenciaFundamental < 1610)
                {
                    lblcolor.Text = "Color azul.";
                }
                if (frecuenciaFundamental > 1990 && frecuenciaFundamental < 2010 )
                {
                    lblcolor.Text = "Color amarillo.";
                }
